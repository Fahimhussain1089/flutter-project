...
class _NewItemState extends State<NewItem> {
  ...
  void _saveItem() async {
    //ye summit botton pe kaam krega
    if (_formKey.currentState!
        .validate()) { //ye validated krega dono botton ko or for loop ki condition ko
      _formKey.currentState!.save(); //save krega
      setState((){
        _isSending = true;
      });
      final url = Uri.https(
          'flutter-prep-5798b-default-rtdb.firebaseio.com',
          'shopping-list.json');

      // post request hit hogi
                    ...
                    child: TextFormField(
                        ...
                        validator: (value) {
                          if(value == null ||
                            ...
                            return 'Number dek se likooo ,positive, integer ';
                          }
